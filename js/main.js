...
// 햄버거 내 언어 버튼
document.querySelectorAll('#hamburger-panel .settings-lang-btn').forEach(btn => {
  btn.addEventListener('click', () => {
...
function updateHamburgerTheme() {
  ...
  // 언어 active 동기화
  document.querySelectorAll('#hamburger-panel .settings-lang-btn').forEach(b => {
