---
title: "도덕적 해이 (Moral Hazard)"
description: "실패의 비용을 타인에게 전가할 수 있다면, 사람들은 더 무모해진다."
levels: "중급"
tags: ["오스트리아 경제학"]
weight: 13
---
...
도덕적 해이(Moral Hazard)란 **위험의 비용을 타인에게 전가할 수 있을 때, 개인이나 조직이 더 큰 위험을 감수하게 되는 현상**입니다. 쉽게 말해, "실패해도 내가 손해 보지 않는다면, 더 무모하게 행동한다"는 것입니다.

이 개념은 원래 보험업계에서 비롯되었지만, 현대 금융 시스템과 정부 정책을 이해하는 데 핵심적인 도구입니다. 특히 오스트리아 경제학의 관점에서 도덕적 해이는 [법정화폐](/ideas/fiat-money/) 시스템이 만들어내는 가장 파괴적인 인센티브 왜곡 중 하나입니다.
...
보험업계는 이 문제를 잘 알고 있으며, 자기부담금(deductible), 할증, 보험료 차등 등의 메커니즘으로 대응합니다. 즉, 시장은 도덕적 해이를 **억제하는 방향**으로 작동합니다.

## "대마불사": 금융 시스템의 도덕적 해이

문제는 정부와 중앙은행이 도덕적 해이를 억제하는 대신 **체계적으로 확대**할 때 발생합니다.
...
1. 대형 은행이 고위험 투자로 막대한 수익을 올리면, 그 이익은 **경영진과 주주**의 것입니다
2. 고위험 투자가 실패하면, 그 손실은 **납세자와 통화 가치 하락을 통해 시민 전체**가 부담합니다
3. 따라서 합리적인 전략은 **가능한 한 큰 위험을 감수하는 것**입니다

이것은 "이기면 내 돈, 지면 남의 돈"이라는 **비대칭적 인센티브**입니다. 이런 구조에서 무모한 행동은 비합리적인 것이 아니라, 오히려 **가장 합리적인 선택**이 됩니다.
...
결과적으로 무모한 위험을 감수한 금융기관은 **구제**되었고, 그 비용은 납세자와 인플레이션을 통해 시민 전체가 부담했습니다.

### 교훈 없는 교훈

더 심각한 문제는 2008년의 구제가 **미래의 도덕적 해이를 더욱 강화**했다는 것입니다. "정부는 결국 구제한다"는 믿음이 확인되었기 때문입니다.

2008년 이후 대형 은행들은 오히려 더 커졌습니다. 규제가 강화되었지만, 근본 구조 — 이익은 사유화하고 손실은 사회화하는 구조 — 는 변하지 않았습니다. [경기변동이론](/ideas/abct/)이 설명하는 호황-불황 사이클의 근저에 이 도덕적 해이가 있습니다.
...
현재 비용을 미래 세대에게 전가하는 것 — 이것이 국가 수준의 도덕적 해이입니다. 미국의 국가 부채가 30조 달러를 초과한 것은 이 도덕적 해이의 누적된 결과입니다.
...
1. 위기 발생 → 정부가 구제
2. 구제가 성공 → "다음에도 구제해줄 것"이라는 기대 형성
3. 기대 형성 → 더 큰 위험 감수
4. 더 큰 위험 → 더 큰 위기 발생
5. 더 큰 위기 → 더 큰 규모의 구제 필요
...
- **개인 책임**: 개인 키를 잃으면 영원히 복구 불가능합니다. 이것은 냉정하지만, 진정한 소유권에는 **책임**이 따른다는 원칙의 구현입니다
...
이것은 비트코인이 구제금융과 도덕적 해이에 대한 **직접적인 대답**으로 태어났다는 선언입니다.

## 연결되는 개념

- [경기변동이론](/ideas/abct/) — 도덕적 해이가 만들어내는 호황-불황 사이클
- [법정화폐](/ideas/fiat-money/) — 도덕적 해이를 가능하게 하는 화폐 시스템
- [칸티용 효과](/ideas/cantillon-effect/) — 구제금융과 화폐 발행이 만드는 불공정한 부의 재분배
- [건전화폐](/ideas/sound-money/) — 도덕적 해이를 구조적으로 억제하는 화폐의 속성
