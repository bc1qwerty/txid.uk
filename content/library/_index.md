---
title: "자료실"
description: "비트코인, 오스트리아 경제학, 자유주의를 깊이 공부하기 위한 큐레이션된 자료 모음입니다."
---

엄선된 책, 아티클, 영상을 난이도별로 정리했습니다. 한국어로 출간된 도서를 중심으로, 원서 자료도 함께 안내합니다.

<span class="level-guide">
<span class="level level-입문">입문</span> 배경지식 없이 읽을 수 있는 자료 ·
<span class="level level-중급">중급</span> 기본 개념을 알면 좋은 자료 ·
<span class="level level-심화">심화</span> 깊은 이해를 위한 자료
</span>
...
- **비트코인 화폐의 미래** — 사이페딘 아모스 / 임경은 역 (다산북스, 2025) <span class="level level-입문">입문</span>
  원제: *The Bitcoin Standard*. 금과 달러부터 비트코인까지, 화폐의 역사를 통해 비트코인이 건전화폐인 이유를 설명하는 필독서.
- **더 피아트 스탠다드** — 사이페딘 아모스 / 임경은 역 (다산북스, 2024) <span class="level level-중급">중급</span>
  원제: *The Fiat Standard*. 법정화폐 시스템의 구조적 결함과 비트코인이 등장할 수밖에 없었던 이유.
- **미래의 가격** — 제프 부스 / 강성실 역 (한국물가정보, 2021) <span class="level level-입문">입문</span>
  원제: *The Price of Tomorrow*. 기술 디플레이션과 인플레이션 화폐 시스템의 충돌.
- **비트코인, 블록체인과 금융의 혁신** — 안드레아스 안토노풀로스 / 김도훈 외 역 (고려대학교출판문화원, 2015) <span class="level level-중급">중급</span>
  원제: *Mastering Bitcoin* 1판. 비트코인의 기술적 원리와 블록체인 작동 방식.
...
- **경제학 1교시** — 헨리 해즐릿 / 전동균, 임석빈 역 (행간, 2006) <span class="level level-입문">입문</span>
  원제: *Economics in One Lesson*. 바스티아의 "보이는 것과 보이지 않는 것"에 기반한, 가장 쉽고 명쾌한 경제학 입문서.
- **정부는 우리 화폐에 무슨 일을 해왔는가?** — 머레이 로스바드 / 전용덕 역 (지식을만드는지식, 2012) <span class="level level-입문">입문</span>
  원제: *What Has Government Done to Our Money?* 정부의 화폐 개입이 인플레이션과 경기변동을 만드는 과정.
- **국민경제학의 기본원리** — 칼 멩거 / 민경국 외 역 (자유기업원, 2002) <span class="level level-중급">중급</span>
...
#### 한국인 저자
- **권리, 시장, 정부** — 전용덕 (2007) <span class="level level-심화">심화</span>
  미제스와 로스바드 이론에 기반하여 권리, 시장, 정부의 관계를 분석한 한국어 원서.

### 자유주의

- **법** — 프레데릭 바스티아 / 김정호 역 (자유기업원, 2016) <span class="level level-입문">입문</span>
...
- **국부론** (상/하) — 애덤 스미스 / 김수행 역 (비봉출판사, 2007) <span class="level level-심화">심화</span>
  원제: *The Wealth of Nations*. 분업, 자유무역, 보이지 않는 손을 논한 경제학의 시원적 고전.
...
- **[Gradually, Then Suddenly 시리즈](https://nakamotoinstitute.org/mempool/series/gradually-then-suddenly/)** (Parker Lewis) <span class="level level-입문">입문</span> — 비트코인이 화폐가 되어가는 과정
- **[The Use of Knowledge in Society](https://www.econlib.org/library/Essays/hykKnw.html)** (Friedrich Hayek) <span class="level level-중급">중급</span> — 분산된 지식과 시장가격의 역할

---

## 영상 자료

- **[Fear the Boom and Bust](https://www.youtube.com/watch?v=d0nERTFo-Sk)** — 하이에크 vs 케인즈 랩배틀 (10분)
- **[Fight of the Century](https://www.youtube.com/watch?v=GTQnarzmTOc)** — 하이에크 vs 케인즈 랩배틀 시즌 2 (10분)
...
- **[The Bitcoin Standard Podcast](https://saifedean.com/podcast/)** — Saifedean Ammous의 경제학 팟캐스트
- **[Mises Media](https://mises.org/media)** — Mises Institute 강연 및 토론

---

<span class="level-guide">
한국어 번역이 없는 주요 원서는 <a href="https://mises.org">mises.org</a>에서 무료로 읽을 수 있습니다.
<a href="https://miseskorea.org">미제스 연구소 한국</a>에서도 일부 한국어 PDF를 배포합니다.
</span>
